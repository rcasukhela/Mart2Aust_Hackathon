...
def main():
    ...
    CS= orix.quaternion.symmetry.O # 432

    # Assemble a "center" orientation for the unimodal ODF using orix
    ori_center = numpy.radians([138.84191326, 101.29425414, 343.75674971]) # Input degree, output radian
    ...
    ori_g = numpy.radians([[107.0280, 43.8449, 260.18], [106.0, 42.0, 259.0]]) # Input degree, output radian
